...
describe('27. Remove internal links', () => {
  it('remove internal links from the values in the Infobox "country"', async () => {
    expect(await ex27()).toEqual({
      linking_name:
      ...
      established_event6:
        'Accession of the United Kingdom to the European Communities{{refn|group=note|European Union since 1993.}}',
      ...
      date_format:
        '{{abbr|dd|day}}/{{abbr|mm|month}}/{{abbr|yyyy|year}}<br />{{abbr|yyyy|year}}-{{abbr|mm|month}}-{{abbr|dd|day}}&nbsp;(Anno Domini)',
      electricity: '230 V–50 Hz',
      drives_on:
        'Left- and right-hand traffic<ref group=note>Except two overseas territories, Gibraltar, the British Indian Ocean Territory and Savoy Court in London.</ref>',
      calling_code:
        'Telephone numbers in the United Kingdom<ref group=note>Telephone numbers in the United Kingdom#Telephone numbers in Overseas Territories</ref>',
      cctld:
